    ...
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <h2 className='text-lg font-semibold'>NPR{props.fare.car}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
                ...
                <h2 className='text-lg font-semibold'>NPR{props.fare.moto}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
               props.setVehicleType('auto');
                ...
                <h2 className='text-lg font-semibold'>NPR{props.fare.auto}</h2>
            </div>
        </div>
    )
}
